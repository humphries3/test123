Attribute VB_Name = "ModuleV2"
Option Explicit
'''''''''''''''
Public Const MOD_DATE = "2020-02-17"
Public Const MOD_VER = 2
Public Const BLANK = " "
Public Const PERIOD = "."
Public Const COMMA = ","
Public Const HYPHEN = "-"
...
MsgBox "Conversion finished:" _
    & vbCrLf & "Rows (Access) (" & (shPhotosAcc.RowLast - 1) & ")" _
    & vbCrLf & "Rows flagged (" & ErrorRows & ")" _
    & vbCrLf & "Rows normalized (" & (shPhotosCnv.RowLast - 1) & ")" _
    & vbCrLf & "Rows skipped (INDEXES) (" & IndexRows & ")" _
    & vbCrLf & "Rows skipped (BLANK) (" & BlankRows & ")"
    
Call logMsg(0, "Rows (Access) (" & (shPhotosAcc.RowLast - 1) & ")", "")
Call logMsg(0, "Rows flagged (" & ErrorRows & ")", "")
Call logMsg(0, "Rows normalized (" & (shPhotosCnv.RowLast - 1) & ")", "")
Call logMsg(0, "Rows skipped (INDEXES) (" & IndexRows & ")", "")
Call logMsg(0, "Rows skipped (BLANK) (" & BlankRows & ")", "")
